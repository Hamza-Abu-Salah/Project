                ...
                <table class="text-center table table-hover table-bordered  table-striped">
                    ...
                    @forelse($items as $item)
                        <tr>
                            ...
                            <td>
                                <a href="/user/tasks/complete/{{$item->task_id}}/{{$item->id}}" class="btn btn-primary btn-sm">Complete</a>
                                <a href="/user/tasks/cancel/{{$item->task_id}}/{{$item->id}}" class="btn btn-danger btn-sm">Cancel</a>
                            </td>
                        </tr>
                    @empty
                    <tr>
